...
// 分类展示去掉"维修费-"前缀，直接展示为 耗材 / 轮胎 等
function catLabel(c: MaintenanceCategory) {
  return c.replace('维修费-', '');
}
...
// 0.1：仅已审核通过的维修记录落入表格；付款状态用 paymentDate 是否存在表示
const seed: Partial<MaintenanceRecord>[] = [
  ...
  { id: 'MT_020', dataSource: 'table_import', date: '2026-06-06', vendor: '鑫源轮胎', vehiclePlate: '赣J0506D', description: '新胎更换两条', amount: 1900, images: [expenseImages[0]], paymentDate: '2026-06-07' }
];
